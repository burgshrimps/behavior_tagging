...
function create_gui
    %% Load video 
    [filename, pathname] = uigetfile({'*.mp4', '*.avi'});
    ...
    uicontrol('Style','text','position',[400 100 100 25],'String', 'Stimulus Presentation');
    uicontrol('Style','text','position',[400 50 100 25],'String', 'Decision Point');
